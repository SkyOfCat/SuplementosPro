  ...
  const cargarAminoacido = async () => {
    try {
      ...
      if (response.ok) {
        ...
        console.log("Datos cargados del aminoácido:", data);
        ...
        setMensaje("❌ Aminoácido no encontrado");
      } else {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (errorData.detail) {
          ...
          setMensaje(
            "❌ Error al actualizar el aminoácido. Revisa los campos."
          );
        }
      }
    } catch (error) {
              ...
              <div className="form-actions">
                ...
                >
                  {loading ? (
                    ...
                    <>
                      <i className="fas fa-save me-2"></i>Actualizar Aminoácido
                    </>
                  )}
                </button>
                <button
