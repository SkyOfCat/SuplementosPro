...
const AgregarCreatina = () => {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      case "nombre":
        if (!value.trim()) error = "El nombre de la creatina es requerido";
          ...
          <div className="card form-card">
            <div className="card-header bg-dark text-center py-4">
              ...
              <p className="text-light mb-0">
                Complete el formulario para agregar una nueva creatina al
                inventario
              </p>
            </div>
            ...
            <div className="card-body p-5">
              ...
              >
                ...
                <div className="row">
                  {/* Nombre de la Creatina */}
                  <div className="col-md-6 mb-4">
                    <label htmlFor="id_nombre" className="form-label fw-bold">
                      <i className="fas fa-tag me-2"></i>Nombre de la Creatina *
                    </label>
                    <input
                      type="text"
                    ...
                    <div className="form-text">
                      Ingrese el nombre comercial de la creatina
                    </div>
                  </div>

                  {/* Tipo (fijo como Creatina) */}
                  <div className="col-md-6 mb-4">
                    <label htmlFor="id_tipo" className="form-label fw-bold">
                      <i className="fas fa-capsules me-2"></i>Tipo
                    </label>
                    <input
                      type="text"
                      className="form-control form-control-lg"
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 mb-4">
                    <div className="image-upload-card required">
                      ...
                      <div className="form-text">
                        Imagen principal de la creatina (obligatoria)
                      </div>
                      ...
                      {imagePreview && (
                        <div className="mt-3 text-center">
                          ...
                          <img
                            ...
                            alt="Vista previa de la creatina"
                          />
                        </div>
                      )}
                    </div>
                    ...
                    <div className="d-grid gap-3 d-md-flex justify-content-md-end">
                      ...
                      >
                        {loading ? (
                          ...
                          <>
                            <i className="fas fa-save me-2"></i>Guardar Creatina
                          </>
                        )}
                      </button>
                    </div>
...
export default AgregarCreatina;
