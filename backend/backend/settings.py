...
SECRET_KEY = 'django-insecure-rn^wf8k^r*b=cnond)l5f#=&1ho_eos4_lu)ptlz_&dw^6j2qk'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SuplementosPro',        # Nombre de la base de datos
        'USER': 'Kotaro',               # Usuario de PostgreSQL
        'PASSWORD': 'jmapm12a@',        # Contraseña
